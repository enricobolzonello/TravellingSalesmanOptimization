...
app.post("/run", (req, res) => {
    ...
    if(algorithm !== undefined && seed !== undefined && timelimit !== undefined && dataset !== undefined){
        ...
        res.json({
            ...
            filename : path.parse(dataset).name
        });
    }else{
        console.log("Error in some parameters");
        res.json({});
    }
});
